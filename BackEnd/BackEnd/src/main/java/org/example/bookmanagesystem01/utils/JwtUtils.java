...
import org.example.bookmanagesystem01.entity.User; // 新增导入
...
public class JwtUtils {
    ...
    // 新增方法：直接使用 User 实体类生成 Token
    public String generateToken(User user, String userType) {
        Map<String, Object> claims = new HashMap<>();
        claims.put("userType", userType);
        return doGenerateToken(claims, user.getNo()); // 使用 user.getNo() 作为 Subject
    }

    // 保留原有方法：基于 UserDetails 生成 Token
