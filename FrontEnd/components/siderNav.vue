...
<script setup>
	...
	const NavData = ref([
		...
		// {id:4,name:'借阅审核',path:'/pages/CheckManage/CheckManage',icon:'/static/img-index/check.png'},
		{id:5,name:'公告管理',path:'/pages/NoticeManage/NoticeManage',icon:'/static/img-index/notice.png'},
		{id:6,name:'预约管理',path:'/pages/Reservation/Reservation',icon:'/static/img-index/reservation.png'},
		{id:7,name:'统计分析',path:'/pages/Analysis/Analysis',icon:'/static/img-index/analyse.png'}
